...
def inicializar_grafica(nombre_archivo):
    """Inicializa la grafica con el archivo de texto que contiene la expresión"""
    G = nx.Graph()
...
def agarrar_nodos_al_azar(numero_nodos):
    """Agarra nodos al azar de la grafica para la fase adivinatoria"""
    nodos_random = []
...
def existe_trajectoria(G, u, v, k, nodos_rand_unicos, contador):
    """Verifica si existe una trajectoria de u a v con peso menor a k"""
